class TreeView {
  constructor($dom, adapter) {
    ...
    this.$view = $dom.find('.cometix-tree-view');
    this.$tree = this.$view
      .find('.cometix-view-body')
  ...
  _showHeader(repo) {
    ...
    this.$view
      .find('.cometix-view-header')
      .html(
        `<div class="cometix-header-summary">
          <div class="cometix-header-repo">
            <i class="cometix-icon-repo"></i>
            <a href="/${repo.username}">${repo.username}</a> /
            <a data-pjax href="/${repo.username}/${repo.reponame}">${repo.reponame}</a>
          </div>
          <div class="cometix-header-branch">
            <i class="cometix-icon-branch"></i>
